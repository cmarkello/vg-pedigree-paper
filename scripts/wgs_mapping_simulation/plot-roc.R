...
max.log10 <- 0 
min.log10 <- switch(region, "high_conf_hg002_v4.2.1_regions_10M" = -6, "alllowmapandsegdupregions_hg002_v4.2.1_regions_100M" = -5, "mhc_hg002_v4.2.1_regions_100M" = -3.7, "cmrg_hg002_v4.2.1_regions_100M" = -3.0, "high_conf_NO1000GP_hg002_v4.2.1_regions_10M" = -4.5, "alllowmapandsegdupregions_NO1000GP_hg002_v4.2.1_regions_100M" = -4.5, "mhc_NO1000GP_hg002_v4.2.1_regions_100M" = -3, "cmrg_NO1000GP_hg002_v4.2.1_regions_100M" = -3, "AllTandemRepeatsandHomopolymers_slop5_NO1000GP_hg002_v4.2.1_regions_100M" = -4.5, "AllTandemRepeatsandHomopolymers_slop5_hg002_v4.2.1_regions_100M" = -6)
max.log10 <- switch(region, "high_conf_hg002_v4.2.1_regions_10M" = -2, "alllowmapandsegdupregions_hg002_v4.2.1_regions_100M" = -1, "mhc_hg002_v4.2.1_regions_100M" = -1.5, "cmrg_hg002_v4.2.1_regions_100M" = -1.0, "high_conf_NO1000GP_hg002_v4.2.1_regions_10M" = -0.5, "alllowmapandsegdupregions_NO1000GP_hg002_v4.2.1_regions_100M" = -0.5, "mhc_NO1000GP_hg002_v4.2.1_regions_100M" = 0, "cmrg_NO1000GP_hg002_v4.2.1_regions_100M" = 0, "AllTandemRepeatsandHomopolymers_slop5_NO1000GP_hg002_v4.2.1_regions_100M" = -0.5, "AllTandemRepeatsandHomopolymers_slop5_hg002_v4.2.1_regions_100M" = -2)
# Work out a set of bounds to draw the plot on
range.log10 <- min.log10 : max.log10
range.unlogged = 10^range.log10

yaxisrange <- switch(region, "high_conf_hg002_v4.2.1_regions_10M" = c(0.9745,0.996), "alllowmapandsegdupregions_hg002_v4.2.1_regions_100M" = c(0.75,0.97), "mhc_hg002_v4.2.1_regions_100M" = c(0.96,0.995), "cmrg_hg002_v4.2.1_regions_100M" = c(0.91,0.98), "high_conf_NO1000GP_hg002_v4.2.1_regions_10M" = c(0.4,0.85), "alllowmapandsegdupregions_NO1000GP_hg002_v4.2.1_regions_100M" = c(0.1,0.75), "mhc_NO1000GP_hg002_v4.2.1_regions_100M" = c(0.3,0.7), "cmrg_NO1000GP_hg002_v4.2.1_regions_100M" = c(0.45,0.81), "AllTandemRepeatsandHomopolymers_slop5_NO1000GP_hg002_v4.2.1_regions_100M" = c(0.55,0.9), "AllTandemRepeatsandHomopolymers_slop5_hg002_v4.2.1_regions_100M" = c(0.985,0.999))
